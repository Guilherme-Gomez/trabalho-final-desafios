...
```{r}
# Avaliando os dados nulos para ANGULO_FRISO_RODA
...
gb_df_null_ANGULO_FRISO_RODA <- groupBy(df_null_ANGULO_FRISO_RODA, df_null_ANGULO_FRISO_RODA$CODIGO_VAGAO)

nNull_ANGULO_FRISO_RODA_by_CVAGAO <- agg(gb_df_null_ANGULO_FRISO_RODA, Nulls = n(df_null_ANGULO_FRISO_RODA$CODIGO_VAGAO))

nNull_ANGULO_FRISO_RODA_by_CVAGAO.dat <- collect(nNull_ANGULO_FRISO_RODA_by_CVAGAO)
nNull_ANGULO_FRISO_RODA_by_CVAGAO.dat
